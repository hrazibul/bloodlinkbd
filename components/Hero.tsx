...
const Hero: React.FC<HeroProps> = ({ onRegisterClick }) => {
  return (
    <div className="bg-secondary dark:bg-[#2C1A1A] pb-10 pt-16 relative overflow-hidden">
      <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
        <div className="inline-flex items-center gap-2 bg-[#FFCDD2] dark:bg-red-900/30 text-primary dark:text-red-200 px-4 py-1 rounded-full text-xs font-semibold mb-8 animate-bounce">
        ...
        <p className="text-muted-light dark:text-muted-dark mb-8 text-base md:text-lg max-w-2xl mx-auto">
        ...
        <button 
          ...
          className="inline-flex items-center justify-center bg-primary hover:bg-primary-dark text-white font-medium py-4 px-10 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 gap-2 mb-6"
        >
