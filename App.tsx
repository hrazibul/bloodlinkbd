...
type View = 'home' | 'benefits' | 'bloodbanks' | 'privacy';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FDFDFD] dark:bg-[#0F0F10] relative">
      ...
      <main className="flex-grow">
        ...
        {currentView === 'benefits' && <Benefits onBack={() => navigateTo('home')} />}
        {currentView === 'bloodbanks' && <NearbyBloodBanks onBack={() => navigateTo('home')} />}
